...
# evaluate the model
# inference, see if the model acts like a chatbot
# run downstream eval, maybe something like "mteb bench chat"
# do fine-tuning without lora on same model and same dataset and check differences between the models
