...
from torch.nn.parallel import DistributedDataParallel as DDP  # TODO: The DDP part is temporary. Should be removed.
...
class ModelFactory:
    ...
    def get_fsdp_wrapped_model(
        ...
        if 1:  # TODO: Should be removed.
            ...
            fsdp_model = DDP(model, device_ids=[device_id], output_device=device_id)
        print(
