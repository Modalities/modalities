...
#         self._assert_equality_two_models(fsdp_wrapped_model.parameters(),
# updated_model_parameters, must_be_equal=False)
#         self._assert_equality_optimizer_param_group(
#             optimizer.state_dict(), updated_optimizer_state_dict, must_be_equal=True
#         )
#         self._assert_equality_optimizer_state(optimizer.state_dict(), updated_optimizer_state_dict,
#  must_be_equal=False)
