...
def test_fsdp2_gradient_clipper():
    ...
    max_norm = 1.0
    norm_type = GradientClippingMode.P2_NORM
    clipper = FSDP2GradientClipper(model_parts=mock_model, max_norm=max_norm, norm_type=norm_type)
...
def test_fsdp2_logging_only_gradient_clipper():
    ...
    norm_type = GradientClippingMode.P2_NORM
    clipper = FSDP2LoggingOnlyGradientClipper(model_parts=mock_model, norm_type=norm_type)
