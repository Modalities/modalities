...
def test_convert_linear_layer(model: NNModel, r: int, alpha: int):
...
def test_convert_embedding_layer(model: NNModel, r: int, alpha: int):
...
def test_attribute_copying(r: int, alpha: int):
    conv2d = nn.Conv2d(in_channels=3, out_channels=6, kernel_size=5, stride=2, padding=1, dilation=2, groups=1, bias=True)
...
def test_layer_conversion(model: NNModel, r: int, alpha: int, list_allowed_conversion_layers: list):
    recursive_layer_conversion(module=model, r=r, alpha=alpha, target_layers=list_allowed_conversion_layers)
...
def test_no_layer_conversion(model: NNModel, r: int, alpha: int):
    list_allowed_conversion_types = []
    model_before = copy.deepcopy(model)
    recursive_layer_conversion(module=model, r=r, alpha=alpha, target_layers=list_allowed_conversion_types)
    model_after = model
