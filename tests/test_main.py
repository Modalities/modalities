...
def test_e2e_training_run_wout_ckpt(monkeypatch, dummy_data_path, dummy_config):
    # patch in env variables
    monkeypatch.setenv("MASTER_ADDR", "localhost")
    monkeypatch.setenv("MASTER_PORT", "9948")

    dummy_config.training.train_dataloader.config.dataset.config.raw_data_path = dummy_data_path
